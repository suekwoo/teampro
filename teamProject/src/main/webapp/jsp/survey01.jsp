...
<body
					...
					<div class="m-0 p-5">
						...
						<div class="check p-3 m-1" style="text-align: center;">
							...
							<input class="btn-check form-check-input" type="radio"
								name="Radiock1" id="Radio1" checked /> <label
	...
	<footer class="text-center">
		<div class="btn-group" style="margin-top: 5%; width: 450px;">
			<a href="${pageContext.request.contextPath}/jsp/surveyStart.jsp" class="btn btn-outline-dark fs-5">이전</a>
			<a href="${pageContext.request.contextPath}/jsp/survey02.jsp" class="btn btn-dark fs-5" onclick="">다음</a>
		</div>
	</footer>
	<link
