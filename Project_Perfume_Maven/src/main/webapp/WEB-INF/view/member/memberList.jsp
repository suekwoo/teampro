...
<tbody><tr>
  ...
  <th>성별</th>   <th>전화번호</th>  <th>이메일</th> <th>선택</th> 
</tr>
</tbody><tbody>
...
<td><input class="form-check-input" type="checkbox" name="chkdel" value="${m.id}" disabled></td>
</c:when>
<c:otherwise>
<td><input class="form-check-input" type="checkbox" name="chkdel" value="${m.id}"></td>
</c:otherwise>
</c:choose>
</tr>
</c:forEach>
