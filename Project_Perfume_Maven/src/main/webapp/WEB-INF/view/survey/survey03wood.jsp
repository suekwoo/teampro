...
<html>
	...
	if(totalChecked===0){
    	...
    	document.RadioPost.ck3wood.value=Favoriteck;
    	//alert(ck3flower)
    	document.RadioPost.submit()
    }
    ...
    <body style="background-image: url('${pageContext.request.contextPath}/images/surveyback/svWoodback.jpg'); background-size: cover;">
        <nav>
             <!--닫기 버튼 ,사이즈 조절가능 -->
            <button onClick="location.href='${pageContext.request.contextPath}/home/index'" type="button"  
            class="me-5 mt-3 btn btn-light  position-absolute top-0 end-0 translate-middle-x" 
