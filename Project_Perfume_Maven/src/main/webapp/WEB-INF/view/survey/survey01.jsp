...
<html>
  ...
  <body style="background-image: url('${pageContext.request.contextPath}/images/surveyback/svback02.jpg');
          ...
          <div class="row m-0">
              ...
              <div class="check p-3 m-1" style="text-align: center;" >
                <input
                  ...
                  value="1"
                />
                <label class="btn btn-outline-primary form-check-label fs-3 fw-bold" for="Radio1" 
              ...
              <div class="check p-3 m-3" style="text-align: center;">
                <input 
                  ...
                  value="2"
                />
                <label class="btn btn-outline-danger form-check-label fs-3 fw-bold" for="Radio2" 
                      style="width: 80%; padding: 10px;">
                  &nbsp;여성
                </label>
                 </div>
    ...
    <div style="text-align: center;">
      <div
        class="btn-group" style="margin-top: 7%; margin-bottom: 10%; width: 450px;"
      >
      <!-- footer 삭제 a태그 controller 타도록 변경 -->
        <a 
          href="#" onclick="pre('surveyStart')" 
          class="btn btn-outline-dark fs-5"
          >이전</a
          >
        <a
          href="#" onclick="next('survey02')"
